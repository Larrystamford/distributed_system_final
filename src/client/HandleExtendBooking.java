...
public class HandleExtendBooking {
    ...
    public static void createAndSendMessage(Network network, Scanner scanner) {
        ...
        query = new ClientQuery(Constants.EXTEND_BOOKING, payload);
    ...
    public static BookingInfo getUserInputs(Scanner scanner) {
        ...
        System.out.println(Constants.EXTEND_BOOKING_HEADER);
        System.out.println(Constants.SEPARATOR);
        ...
        // Enter offset
        System.out.println(Constants.EXTEND_BOOKING_PROMPT);

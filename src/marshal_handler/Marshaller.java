...
public class Marshaller {
    ...
    public static byte[] marshall(Marshal obj) {
        ...
        byte[] resBytes = Bytes.toArray(res);
        return resBytes;
    }
...
//            if (f.getAnnotation(IgnoreField.class) != null) continue;
            ...
            try {
                ...
                // example -> splitting java.util.list<entity.BookingInfo>
...
//                String fieldName = unmarshallString(byteList);
                ...
                unmarshallString(byteList); // unmarshall the name of the field first
    ...
    private static void marshallSelect(String[] typeWithGeneric, Object o, List<Byte> res) {
        ...
        switch (typeWithGeneric[0]) {
            ...
            case "boolean":
                ...
                break;
            case "java.util.List":
                // copy all the list type from index 1 onwards. (Usually length would be 2, but if list contains another list, the length would be 4 etc)
...
//                return unmarshallDate(byteList);
    ...
    private static List<Byte> stringToByteList(String v) {
        return Bytes.asList(v.getBytes());
    }

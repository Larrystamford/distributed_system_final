...
public class ServerUI {
    public static void printServerResponse(ClientRequest request, ServerResponse response) {
        switch (request.getRequestChoice()) {
            ...
            case Constants.FACILITY_AVAILABILITY -> ClientUI.facilitiesAvailabilityResponse(request, response);
            ...
            case Constants.MONITOR_AND_BOOK_ON_AVAILABLE -> ClientUI.bookingIfVacancyAppearsResponse(request, response);
            default -> {
            }
        }
    }
